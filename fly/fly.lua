    ...
    while true do
        ...
        if goto_enable  then
            ...
            if x and y and z and x == x and y == y and z == z then
                ...
                local result = ((x_vec + y_vec + z_vec) / 10)
...
local function v_pid()
    ...
    while true do
        ...
        while hover_enable and not goto_enable do
            ...
            local y_vel_err = (0.04 * ticks) + target_vel[2] - y
            ...
            print("xz angle: "..xz_angle..", yxz angle: "..yxz_angle..", power:"..power..", result: x: "..result.x.." y:"..result.y.." z: "..result.z)
